...
class Outputs(jsl.Document):
    ...
    class _id(jsl.Document):
        _id = jsl.StringField(pattern='Outputs', required=True)
    ...
    # Instantiate all Outputs properties
    _id = jsl.DocumentField(_id, default='Outputs', required=True)
...
schema = Outputs.get_schema(ordered=True)
