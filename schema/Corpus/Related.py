...
class Related(jsl.Document):
    ...
    class _id(jsl.Document):
        _id = jsl.StringField(pattern='Related', required=True)
    ...
    # Instantiate all Related properties
    _id = jsl.DocumentField(_id, default='Related', required=True)
...
schema = Related.get_schema(ordered=True)
