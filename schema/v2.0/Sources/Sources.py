...
class Publications(jsl.Document):
    ...
    #authors = jsl.ArrayField() # can consist of string values or objects (group/organization).
    ...
    webpage = jsl.UriField()

# Add the global properties to the definitions
def add_global(manifest):
    url = 'https://raw.githubusercontent.com/whatevery1says/manifest/master/schema/v2.0/global/global.json'
